...
export function AboutSection() {
  const experienceData = [
    
    {
      ...
      description:
        "Developed a Gen AI-powered analytics system using Python (Transformers, Scikit-learn) to enable natural language querying in healthcare dashboards, building tools that convert human language to SQL (Gemini Pro, SQLAlchemy) and creating dynamic visualizations (Streamlit, Plotly) while automating PDF data extraction, statistical alerts, and Excel reporting to optimize revenue cycle management.",
    },
    {
      ...
      description:
        "Analyzed hospital readmission rates by processing large healthcare datasets with Python (Pandas, NumPy), identifying key trends through groupby techniques to enable data-driven interventions, and effectively communicating insights through interactive Matplotlib and Plotly visualizations.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            {/* Social Links */}
            <div className="flex gap-3 pt-[4px] pb-[4px] pl-[175px] pr-[175px]">
              <SocialIcon

...
const featuredProjects = [
  {
    ...
    description:
      "A Streamlit-based web app for storing and managing patient health records with CRUD functionality.",
    technologies: ["Python", "Streamlit"],
    liveUrl:
      "https://arvindh99-elecronic-health-record-ehr-t7spor.streamlit.app/",
  ...
  },
  {
    ...
    description:
      "A machine learning-powered web app that predicts whether a Test cricket match is likely to end in a draw or not, and if not, suggests which team has the upper hand.",
  ...
  },
  {
    ...
    description:
      "GitHub Wrapped is a fun, interactive Streamlit app that showcases your GitHub stats in a stylish and engaging way. Just like the Spotify Wrapped, this app will visualize your GitHub activity for the year, highlighting your most important stats like followers, repositories, stars, commits, and more.",
              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    <div
                      className={`w-10 h-10 rounded-lg ${techColors[project.technologies[0]]} flex items-center justify-center mr-3`}
                    >
...
function CodeIcon({ technology }: { technology: string }) {

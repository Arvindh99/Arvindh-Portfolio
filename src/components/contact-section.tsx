              ...
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    {item.href ? (
                      <a href={item.href} className="text-slate-600 hover:text-primary transition-colors">
                        {item.value}
                      </a>
                    ) : (
          ...
          >
            ...
            <div className="pt-4">
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center px-6 py-3 bg-primary hover:bg-primary/90 text-white font-medium rounded-lg transition-all shadow-sm hover:shadow-md"
              >
                View Upwork Profile
              </motion.a>
